...
public class StringMethods {
	...
	public static void main(String[] args) {
		...
		int c = 0;
		String harinderName = "Harinderjit Kaur";
		if (harinderName.contains("i")) {
			c++;
		} else {
		...
		// Array of Strings. Find number of preet in the array of Strings and later on
		// replace preet with jit
		String[] nameList = { "Damanpreet", "Jattanpreet", "Amanpreet", "Kuldeep" };
		int count = 0;
